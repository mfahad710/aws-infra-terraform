...
secondary_region = "ap-northeast-1" # Tokyo region (Aurora secondary)
profile          = "stg"

# ---- Aurora Global Database ----

# Primary (Singapore), reuse the existing neem-stg-vpc resources
rds_primary_db_subnet_group_name = "<rds_primary_db_subnet_group_name>"
...
rds_db_name                 = "<stg_db_name>"
rds_source_master_secret_id = "stg/rds/stg-db-root-secret"
